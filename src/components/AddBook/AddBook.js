...
const AddBook = () => {
  ...
  const handleImageUpload = (event) => {
    ...
    axios
      ...
      .then(function (response) {
        ...
        console.log(
          "Image successfully uploaded to ImageBB: ",
  ...
  const handleSubmit = (event) => {
    ...
    fetch("https://shrouded-caverns-55821.herokuapp.com/addBook", {
      ...
      .then((data) => {
        alert("Book successfully inserted to database.");
    ...
    <div>
      <div className="add-book">
        ...
        <form onSubmit={handleSubmit}>
          <label className="label-highlight" htmlFor="">
            Book Name
          </label>
          <br />
          <input
          ...
          />
          <br />
          <label className="mt-3 label-highlight" htmlFor="">
            Author Name
          </label>
          <br />
          <input
          ...
          />
          <br />
          <label className="mt-3 label-highlight" htmlFor="price">
            Add Price
          </label>
          <br />
          <input
          ...
          />
          <br />
          <label className="mt-3 label-highlight" htmlFor="coverPhoto">
            Add Book Cover Photo
          </label>
          <br />
          <input onChange={handleImageUpload} type="file" id="coverPhoto" />
          <br />
